			...
			<div id="main" class="col small-full medium-col-3 large-col-4">
				...
				<div class="post">
					...
					<div class="col small-full medium-full large-col-3">
						...
						<p class="comments">
							<a href="#"><i class="fa fa-comment"></i> <?php echo get_comments_number(get_the_ID()); ?></a>
						</p> 
					</div>                      	
				</div>
				<!-- .post -->
				...
				<div class="pagination orange">
					...
					<?php if(!is_null(get_next_posts_link())): ?><div class="alignright"><p class="cta older button"><?php next_posts_link( 'Older posts' ); ?></p></div><?php endif; ?>
					<?php if(!is_null(get_previous_posts_link())): ?><div class="alignleft"><p class="cta newer button"><?php previous_posts_link( 'Newer posts' ); ?></p></div><?php endif; ?>
				</div>
				<!-- end pagination -->
